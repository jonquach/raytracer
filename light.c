...
** Last update Mon May 26 16:44:18 2014 frayss_c
*/
...
{
  all->n.px = all->eye.x + (k * all->v.x);
  all->n.py = all->eye.y + (k * all->v.y);
  all->n.pz = all->eye.z + (k * all->v.z);
  my_normal(all, obj);
  all->lum.x2 = all->lum.x - all->n.px;
  all->lum.y2 = all->lum.y - all->n.py;
  all->lum.z2 = all->lum.z - all->n.pz;  
